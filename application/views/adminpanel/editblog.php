...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
   ...
   <form enctype="multipart/form-data" action="<?= base_url() . 'admin/blog/editblog_post' ?>" method="POST">
        ...
        <div class="form-group">
            <input type="text" value ="<?= $result[0]['blog_titile'] ?>" class="form-control" name="blog_title" placeholder="Title">
        </div>
        <br>
        <div class="form-group">
        ...
        <div class="form-group">
        <img width="100" src="<?= base_url().$result[0]['blof_img'] ?>" >
            <input type="file" class="form-control" name="file" placeholder="Title">
        </div>
        <br>
        <button type="submit" class="btn btn-primary">editblog</button>
